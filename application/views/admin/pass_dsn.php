<div class="col-xl-9">
    ...
    <?= form_open_multipart('Admin/changePass');?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="username" value="<?= $dsn->nip ?>" disabled>
                                </div>

                                <div class="form-group">
                                    <label>Nama</label>
                                    <input class="form-control" name="nama" value="<?= $dsn->nama ?>" disabled>
                                </div>
                                
                                <h3>Ganti Password</h3>
                                <input type="hidden" class="form-control" name="url" value="akundsn">
                                ...
                                <div class="form-group">
                                    <input type="hidden" class="form-control" name="username" value="<?= $dsn->nip ?>">
                                </div>
                                <div class="form-group">
