<?php function tgl_indo($tanggal){
        ...
        return $pecahkan[2] . ' ' . $bulan[ (int)$pecahkan[1] ] . ' ' . $pecahkan[0];
                    ...
                    <div class="row">
                        <div class="col-md-8 col-lg-4">
                            <div class="statistic__item statistic__item--green">
                                <h2 class="number"><?= $mahasiswa ?></h2>
                                <span class="desc">Total Mahasiswa</span>
                                <div class="icon">
                        ...
                        <div class="col-md-8 col-lg-4">
                            <div class="statistic__item statistic__item--red">
                                <h2 class="number"><?= $wali ?></h2>
                                <span class="desc">Mahasiswa Perwalian</span>
                                <div class="icon">
                        ...
                        <div class="col-md-8 col-lg-4">
                            <div class="statistic__item statistic__item--blue">
                                <h2 class="number"><?= $dosen ?></h2>
                                <span class="desc">Total Dosen</span>
                                <div class="icon">
            ...
            <h2 style="text-align:center;">Pengumuman</h2><hr>
