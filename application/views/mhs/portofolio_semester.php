                                                                    ...
                                                                    <table class="table table-bordered" width="100%" cellspacing="0">
                                                                        <thead>
                                                                            <tr>
                                                                                ...
                                                                                <!-- <th>Penyelenggara</th> -->
                                                                                <th>Pelaksanaan</th>
                                                                                <!-- <th>Judul Karya / Nama Kegiatan</th> -->
                                                                                <th>Detail</th>
                                                                                <!-- <th>Tingkat</th> -->
                                            ...
                                            <div class="tab-pane fade" id="pills-kompetensi" role="tabpanel" aria-labelledby="pills-kompetensi-tab">
                                                <div class="card" style="padding-top:10px">
                                                    ...
                                                    <script>
                                                        ...
                                                        var otherInput = document.getElementById('otherPenyelenggara');
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <form role="form" method="post" action="<?= base_url('Mhs/insert_prestasi');?>" enctype="multipart/form-data">
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <label>Judul Karya / Nama Kegiatan</label>
...
<?php $username =$this->session->userdata('username');?>
    <script type="text/javascript"> 
        $(document).ready(function(){
            ...
            if(topik != ''){
                $.ajax({
                    url:"<?= base_url('Mhs/checkTopik');?>",
                    method:"GET",
                    data:{topik:topik, username:"<?=$username?>"},
                    dataType: 'json',
                    success:function(data){
                        if (data.cek=="exist"){
                            var id = data.id;
                                                    ...
                                                    <div class="modal fade tambah-kompetensi" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                ...
                                                                <form role="form" method="post" action="<?= base_url('Mhs/insert_kompetensi');?>" enctype="multipart/form-data">
                                                                    <div class="modal-body">
                                                                        <input class="form-control" type="hidden" name="id_portofolio" value="<?=$id_portofolio?>">
                                                                        <input class="form-control" type="hidden" name="semester" value="<?=$semester?>">
                                                                        ...
                                                                        <label>BIdang Ilmu</label><label style="color:red; font-size:12px;"> (*Wajib diisi)</label>
